...
- [x] **TRUST-04**: the trusted-event allowlist has a **single source of truth**; the pre-`npm ci` dependency-free action copy is generated from / shares it (no dual root copy), with a `selfcheck.cjs` parity assertion
